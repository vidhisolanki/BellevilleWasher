...
The moment-rotation behavior decomposed into two parallel components – one elastic and one hysteretic as illustrated in Figure 5-3. The split is given by
...
\hfil
\subfloat{\includegraphics[scale=0.5]{EquiStiffnessDamping2.eps}%
