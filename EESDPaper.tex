...
\begin{figure}
    ...
    \centering
        \includegraphics[width = \textwidth]{Onewasher.eps}
        \caption{Shape and dimension specifications (source: \cite{shigley2004standard})}
        \label{fig:Onewasher}
    \end{subfigure}
     \begin{subfigure}[b]{0.5\textwidth}
    \centering
        \raisebox{0.8em}{\includegraphics[width = \textwidth]{Photo_2units2U2D.eps}}
        \caption{Example of a stack with series-parallel arrangement}
...
\begin{figure}
    \centering
    \resizebox{0.5\textwidth}{!}{\includegraphics{Forcedisponewasher.eps}}
...
\begin{center}   
\begin{tabular}{cccm{5em}} 
 \toprule
 \multicolumn{3}{c}{Units} & \multirow{2}{*}{Stack} \\
 Sr. No. & Configuration & Nomenclature & \\
 1 & \resizebox{0.2\textwidth}{!}{\includegraphics{washer1U.eps}} & 1U & \multirow{5}{*}{\resizebox{0.2\textwidth}{!}{\includegraphics{washer2unit2U2D.eps}}}\\
 2 & \resizebox{0.2\textwidth}{!}{\includegraphics{washer1D.eps}} & 1D & \\
 3 & \resizebox{0.2\textwidth}{!}{\includegraphics{washer1U1D.eps}} & 1U1D & \\
 4 & \resizebox{0.2\textwidth}{!}{\includegraphics{washer1unit2U2D.eps}} & 2U2D & \\
 5 & \resizebox{0.2\textwidth}{!}{\includegraphics{washer1unit3U3D.eps}} & 3U3D & \\
\bottomrule
%\multicolumn{3}{l}{\small{$^1$Obtained from \cite{kote2019model}}}
\end{tabular}
\end{center}
