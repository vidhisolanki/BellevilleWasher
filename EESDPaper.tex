...
%\begin{center}   
%\begin{tabular}{cccm{3cm}} 
% \toprule
% \multicolumn{3}{c}{Units} & Stack \\
% Sr. No. & Configuration & Nomenclature & \\
% 1 & \resizebox{0.2\textwidth}{!}{\includegraphics{washer1U.eps}} & 1U & %\multirow{4}{3cm}{\resizebox{0.4\textwidth}{!}{\includegraphics{washer2unit2U2D.eps}}}\\
...
% 5 & \resizebox{0.2\textwidth}{!}{\includegraphics{washer1unit3U3D.eps}} & 3U3D & Happy \\
%\bottomrule
%\multicolumn{3}{l}{\small{$^1$Obtained from \cite{kote2019model}}}
%\end{tabular}
%\end{center}
